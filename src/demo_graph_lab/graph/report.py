"""Render keyframes, extracted constraints, validation, and gold labels as HTML."""
...
_TPL = """<!doctype html><html><head><meta charset="utf-8"><title>{{ task }} · graph report</title>
<style>
...
def run(task: str) -> None:
    ...
    validation = artifacts.read_json(run_dir / "validation.json")
    ...
    for st in graph["stages"]:
        frames = [dict(f, b64=artifacts.b64_jpeg(run_dir / f["file"]))
