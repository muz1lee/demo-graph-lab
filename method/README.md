...
对照 `../docs/archive/PROPOSAL_v2.md`（v2，2026-07-29）——下表四行引的都是 v2 原文；v3 的对应位是
`../docs/PROPOSAL.md` §5（冻结的可操作定义）与 §6 假设 **A6**（冻结成立、无任务泄漏）：
...
而 v2 抬头「本轮决策」行自己写明：「执行与**冻结协议实验后置到 Phase 1/2**」——是**后置，不是取消**。
...
2. `../docs/PROPOSAL.md` §6 的假设 A1–A7 与 `../docs/EXECUTION.md` §1 的实验与验收中**没有任何一条**需要它。

判断规则（可自查）：**「`PROPOSAL.md` §6 的假设、或 `EXECUTION.md` §1 的实验与验收里，有没有哪条需要它？」**
