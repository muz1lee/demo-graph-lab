...
**排期锚点**：W1–W2 = 因果链 MVS（A 线）∥ T-GEN-1/2（B 线）∥ T-THM-1（PI）；W3 = **D0** + T-GEN-3/4；W4 = T-BP-1/2 + **E-CHAIN oracle 态试点**（只作上界与管线验证，D-05 标签纪律）；W5+ = 非特权感知链（P1-04..07，D-20 必做）+ T-ROB 与 E-ROB 跟进。
