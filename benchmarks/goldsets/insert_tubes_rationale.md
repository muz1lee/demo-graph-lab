...
- `approach_direction(top_down, tube)` **incidental**: frames do show an over-the-top descent, but the pick-side approach cone is a free choice for a rotationally symmetric lying tube. Side and top-down approaches belong to the same equivalence class here.
